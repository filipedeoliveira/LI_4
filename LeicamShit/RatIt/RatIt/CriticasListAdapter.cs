...
namespace RatIt
{
    class CriticasListAdapter : BaseAdapter<Critica>
    {
        private List<Critica> items;
        private Context mcontexto;
        private int nLayout;

        public CriticasListAdapter(Context contexto, int layout, List<Critica> list)
        {
            items = list;
            nLayout = layout;
            mcontexto = contexto;
        ...
        public override Critica this[int position]
        {
            get
            {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            txtRest.Text = items[position].Restaurante;
